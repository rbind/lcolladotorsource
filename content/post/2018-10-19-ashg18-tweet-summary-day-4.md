...
{{% tweet user="lcolladotor" id="1053369322981085184" %}}
...
{{% tweet user="splon" id="1053427841029693440" %}}

{{% tweet user="splon" id="1053428153857728512" %}}

{{% tweet user="michaelhoffman" id="1053429511604195328" %}}

{{% tweet user="cgonzagaj" id="1053429846821429249" %}}

{{% tweet user="cgonzagaj" id="1053433460721836032" %}}

{{% tweet user="_chriscole_" id="1053432233610989568" %}}
...
{{% tweet user="CatCafeSanDiego" id="1053358887737442305" %}}

{{% tweet user="bioinfo_mark" id="1053365107235807233" %}}

{{% tweet user="23andMeResearch" id="1053434810150993921" %}}
